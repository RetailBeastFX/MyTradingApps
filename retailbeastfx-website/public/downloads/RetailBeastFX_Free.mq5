...
input group "=== SESSION TIMES (Coinexx GMT+2) ==="
input string InpBrokerNote = "Coinexx GMT+2 - ICT Killzone Times"; // Broker Note
...
input color InpBullOBColor = C'40,80,60';    // Bullish OB Color (Muted Green)
input color InpBearOBColor = C'90,50,60';    // Bearish OB Color (Muted Maroon)
...
input int InpGMTOffset = 2;                  // Broker GMT Offset (Coinexx=2, FTMO=2/3, OANDA=0)
...
void DrawOrderBlock(OrderBlock &ob)
{
   ...
   // Main OB rectangle (outline style for cleaner look)
   ...
   ObjectSetInteger(0, ob.name, OBJPROP_FILL, false);  // Outline only - ICT style
